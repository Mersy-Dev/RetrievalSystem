...
const Hero = () => {
  ...
  return (
    <section className="bg-white dark:bg-gray-900 py-16 md:mt-20 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-10">
        {/* Left Text Content */}
        <div className="md:w-1/2 space-y-6">
          <h1 className="text-6xl font-bold text-gray-900 dark:text-white leading-tight">
            {t("home.hero.title") || "Smarter Malaria Awareness Starts Here"}
          </h1>
          ...
          <div className="flex items-center gap-4">
            ...
            >
              {t("home.hero.cta2") || "Explore Malaria Data"}
            </Link>
          </div>
          <ul className="text-sm text-gray-700 dark:text-gray-300 list-disc pl-5 mt-4 space-y-1">
            <li>{t("home.hero.feature1") || "Access comprehensive malaria data"}</li>
            <li>{t("home.hero.feature2") || "Get real-time updates on outbreaks"}</li>
            <li>{t("home.hero.feature3") || "Learn about prevention and treatment"}</li>
            <li>{t("home.hero.feature4") || "Engage with community health workers"}</li>
          </ul>
        </div>
        ...
        <div className="md:w-1/2 w-full h-[400px] md:h-[500px] relative rounded-2xl shadow-2xl overflow-hidden">
          <Image
            ...
            alt={t('home.hero.imageAlt') || "Illustration of malaria system"}
            fill
